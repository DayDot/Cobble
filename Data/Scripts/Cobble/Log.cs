...
namespace DayDot
{
    ...
    {
        public static string modName = "DayDot.Cobble";
        public static string modFolder = "DayDot.Cobble";
        ...
        {
            Error(msg, modName + " error - open %AppData%/MedievalEngineers/Storage/" + workshopId + "_" + modFolder + "/" + LOG_FILE + " for details");
        }
